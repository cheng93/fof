...
class StatsKicking(BaseStats):
    def __init__(self):
        self.stats = [
            "Field_Goals_Made",
            "Field_Goals_Attempted",
            "Long_Field_Goal",
            "Points_After_Touchdown",
            "PATs_Attempted"
        ]
    ...
    def execute(self, cursor, year):
        ...
        table_definition = """
            ...
            long_field_goal SMALLINT,
            points_after_touchdown SMALLINT,
            pats_attempted SMALLINT
        """
